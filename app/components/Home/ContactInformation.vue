<template>
      <div class="flex flex-col gap-6 ">
        <div class="rounded-xl p-6 bg-gradient-to-br from-slate-900/60 to-slate-800/40 border border-slate-700">
          <h3 class="text-xl font-semibold text-white mb-2">{{ $t('Contact Information') }}</h3>
          <p class="text-sm text-slate-300 mb-10">{{ $t('Reach out') }}.</p>
          ...
          <ul class="space-y-3">
            ...
            <li class="flex items-start gap-3">
              ...
              <div class="flex-1">
                <a :href="`mailto:${social.email}`" class="text-sm font-medium text-white hover:underline">{{ social.email || '—' }}</a>
                <p class="text-xs text-slate-400">{{ $t('Send us an email') }}</p>
              </div>
            </li>
            ...
            <li class="flex items-start gap-3">
              ...
              <div class="flex-1">
                <a :href="social.facebook" target="_blank" rel="noreferrer" class="text-sm font-medium text-white hover:underline">
                  Facebook
                </a>
                <p class="text-xs text-slate-400 truncate max-w-xs">{{ social.facebook }}</p>
              </div>
            </li>
            ...
            <li class="flex items-start gap-3">
              ...
              <div class="flex-1">
                <a href="https://www.google.com/maps/place/%D9%85%D8%AF%D8%B1%D8%B3%D8%A9+%D8%A7%D9%84%D8%B4%D8%A7%D9%85+%D8%A7%D9%84%D8%AF%D9%88%D9%84%D9%8A%D8%A9+%D8%A7%D9%84%D8%A7%D9%81%D8%AA%D8%B1%D8%A7%D8%B6%D9%8A%D8%A9%E2%80%AD/@32.7162256,36.5754757,17z/data=!3m1!4b1!4m6!3m5!1s0x15197f004a8e9129:0x5c62b45225c8e431!8m2!3d32.7162256!4d36.5754757!16s%2Fg%2F11y4vdl6w6!17m2!4m1!1e3!18m1!1e1?entry=ttu&g_ep=EgoyMDI1MTExNy4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noreferrer" class="text-sm font-medium text-white hover:underline">
                  شارع قنوات, As Suwayda, Syria
                </a>
                <p class="text-xs text-slate-400">{{ $t('Visit us — location on Google Maps') }}</p>
              </div>
            </li>
          </ul>
        </div>
